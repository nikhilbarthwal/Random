#ifndef CONTRACT_READER_H
#define CONTRACT_READER_H
...
class ContractReader : public EWrapper, public EClientSocket {

public:
ContractReader(const char *host, int port, int clientId = 0);
~ContractReader();
