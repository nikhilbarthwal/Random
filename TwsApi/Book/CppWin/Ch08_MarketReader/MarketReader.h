#pragma once
#pragma once
#ifndef MARKET_READER_H
#define MARKET_READER_H
...
class MarketReader : public EWrapper, public EClientSocket {

public:
MarketReader(const char *host, int port, int clientId = 0);
~MarketReader();
