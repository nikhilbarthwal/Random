#pragma once
#ifndef AVERAGE_TRUE_RANGE_H
#define AVERAGE_TRUE_RANGE_H
...
class AverageTrueRange : public EWrapper, public EClientSocket {

public:
AverageTrueRange(const char *host, int port, int clientId = 0);
~AverageTrueRange();

EReader *reader;
EReaderOSSignal signal;
std::deque<double> trueRanges;
std::vector<double> atrVals;
double oldClose;
