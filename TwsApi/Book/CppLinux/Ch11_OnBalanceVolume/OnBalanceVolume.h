#ifndef ON_BALANCE_VOLUME_H
#define ON_BALANCE_VOLUME_H
...
class OnBalanceVolume : public EWrapper, public EClientSocket {

public:
OnBalanceVolume(const char *host, int port, int clientId = 0);
~OnBalanceVolume();

EReader *reader;
EReaderOSSignal signal;
double oldClose;
std::vector<long long> obvVals;
