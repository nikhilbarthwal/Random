#ifndef STOCK_SCANNER_H
#define STOCK_SCANNER_H
...
class StockScanner : public EWrapper, public EClientSocket {

public:
StockScanner(const char *host, int port, int clientId = 0);
~StockScanner();
