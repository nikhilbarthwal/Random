#ifndef SUBMIT_ORDER_H
#define SUBMIT_ORDER_H
...
class SubmitOrder : public EWrapper, public EClientSocket {

public:
SubmitOrder(const char *host, int port, int clientId = 0);
~SubmitOrder();
