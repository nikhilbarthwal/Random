...
class Macd : public EWrapper, public EClientSocket {

public:
Macd(const char *host, int port, int clientId = 0);
~Macd();

EReader *reader;
EReaderOSSignal signal;
double slowAlpha, fastAlpha, macdAlpha;
std::deque<double> slowEma, fastEma, macdEma;
std::vector<double> macdVals, signalVals;
