#ifndef TRUE_STRENGTH_H
#define TRUE_STRENGTH_H
...
class TrueStrength : public EWrapper, public EClientSocket {

public:
TrueStrength(const char *host, int port, int clientId = 0);
~TrueStrength();

EReader *reader;
EReaderOSSignal signal;  double slowAlpha, fastAlpha, oldClose;
std::deque<double> numBase, num, denBase, den;
std::vector<double> tsiVals;
