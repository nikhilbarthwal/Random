#ifndef CHAIN_READER_H
#define CHAIN_READER_H
...
class ChainReader : public EWrapper, public EClientSocket {

public:
ChainReader(const char *host, int port, int clientId = 0);
~ChainReader();
